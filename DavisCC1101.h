...
#ifndef DAVISCC1101_h
#define DAVISCC1101_h
...
#define CC1101_IRQ_PIN 2
#define CC1101_IRQ_NUM 0
#define CC1101_IRQ2_PIN 3
#define CC1101_IRQ2_NUM 1
#elif defined(__AVR_ATmega644P__) || defined(__AVR_ATmega1284P__)
#define CC1101_IRQ_PIN 2
#define CC1101_IRQ_NUM 2
#elif defined(__AVR_ATmega32U4__)
#define CC1101_IRQ_PIN 3
#define CC1101_IRQ_NUM 0
#else
#define CC1101_IRQ_PIN 2
#define CC1101_IRQ_NUM 0
...
#define CC1101_MODE_SLEEP 0   // XTAL OFF
#define CC1101_MODE_IDLE 1 // XTAL ON
#define CC1101_MODE_SYNTH 2   // PLL ON
#define CC1101_MODE_RX 3      // RX MODE
#define CC1101_MODE_TX 4      // TX MODE

#define CC1101_DAVIS_BW_NARROW 1
#define CC1101_DAVIS_BW_WIDE 2

#define null 0
#define COURSE_TEMP_COEF -90                      // puts the temperature reading in the ballpark, user can fine tune the returned value
#define CC1101_FSTEP kCrystalFrequency / (2 ^ 16) // FXOSC/2^16 (see datasheet)
...
public:
  ...
  DavisCC1101(byte slaveSelectPin = SPI_CS, byte interruptPin = CC1101_IRQ_PIN, bool isCC1101 = false, byte interruptNum = CC1101_IRQ_NUM)
  {
    _slaveSelectPin = slaveSelectPin;
    _interruptPin = interruptPin;
    _interruptNum = interruptNum;
    _mode = CC1101_MODE_IDLE;
  ...
  void setPowerLevel(byte dBm);  // reduce/increase transmit power level
...
protected:
  ...
  static DavisCC1101 *selfPointer;
